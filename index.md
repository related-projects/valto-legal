...
reports how many rules failed, out of how many were checked. The report carries
no reference to any rule, no amount, no name and no note. This exists so that a
scheduled entry which silently fails to happen can be found and fixed.
